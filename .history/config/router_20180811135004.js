...
const Tabs = createMaterialTopTabNavigator(
	{
		Tab1: {
			...
			navigationOptions: {
				title: 'Home',
				tabBarIcon: <Icon name="home" size={30} iconStyle={styles.icon} />
			}
		},
		Timer: {
			screen: Timer,
			navigationOptions: {
				tabBarIcon: <Icon name="alarm" size={30} iconStyle={styles.icon} />
			}
		},
		Guided: {
			screen: Guided,
			navigationOptions: {
				tabBarIcon: <Icon name="record-voice-over" size={30} iconStyle={styles.icon} />
			}
		},
		Presets: {
			screen: Presets,
			navigationOptions: {
				tabBarIcon: <Icon name="tune" size={30} iconStyle={styles.icon} />
			}
		}
	},
	{
