...
const Tabs = createMaterialTopTabNavigator(
	{
		Tab1: {
			...
			navigationOptions: {
				title: 'Home',
				tabBarIcon: <Icon name="home" size={25} style={styles.icon} />
			}
		},
		Timer: {
			screen: Timer,
			navigationOptions: {
				tabBarIcon: <Icon name="alarm" size={25} style={styles.icon} />
			}
		},
		Guided: {
			screen: Guided,
			navigationOptions: {
				tabBarIcon: <Icon name="record-voice-over" size={25} style={styles.icon} />
			}
		},
		Presets: {
			screen: Presets,
			navigationOptions: {
				tabBarIcon: <Icon name="tune" size={25} style={styles.icon} />
			}
		}
	},
	{
