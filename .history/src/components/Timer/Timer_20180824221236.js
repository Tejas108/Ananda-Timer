...
export default class Timer extends Component {
	...
	handleTimer = (min, int, mu) => {
		if (min && int && mu) {
			console.log('min:' + this.state.minutes + 'int:' + this.state.interval + 'check:' + this.state.ambChecked);
			//this.setState({ minutes: min, interval: int, ambChecked: mu }, () => {});
		}
		console.log('min:' + this.state.minutes + 'int:' + this.state.int + 'check:' + this.state.ambChecked);
					...
					<View style={styles.sliderWrap}>
						...
						{params ? (
							<Button
								...
								fontFamily={'Helvetica'}
								fontSize={24}
								onPress={this.handleTimer.bind(this, params.min, params.int, params.music)}
