...
export default class Timer extends Component {
	...
	handleModal = () => {
		//this.state.error ?  : this.setState({ isModal: !this.state.isModal });
	};
			...
			<View style={{ flex: 1 }}>
				...
				>
					<View style={styles.modalContent}>
						...
						<FormInput />
						this.state.error ?
						<FormValidationMessage labelStyle={styles.modalValMsg}>Please Enter A Name!</FormValidationMessage> : null;
						<Button
							buttonStyle={styles.button}
							rounded={true}
							fontFamily={'Helvetica'}
