...
export default class Timer extends Component {
	...
	handleTimer = () => {
		...
		if (m > 0) {
			this.setState(
				{ isButtonDisabled: false, isTimer: !currTimer, tick: m, interval: ivl, minutes: m, ambChecked: mus },
				() => {}
			);
			time = m * 60000;
			if (ivl > 0) {
			...
			this.setState({ isButtonDisabled: false, isTimer: !currTimer, tick: this.state.minutes }, () => {});
					...
					<View style={styles.sliderWrap}>
						...
						{params ? (
							...
							<Slider
								...
								maximumValue={180}
								step={5}
								onValueChange={minutes => this.setState({ minutes: minutes, isButtonDisabled: false })}
								minimumTrackTintColor="#ffcd32"
								maximumTrackTintColor="#ffffff"
								thumbTintColor="#3C3B85"
								thumbTouchSize={{ width: 60, height: 60 }}
