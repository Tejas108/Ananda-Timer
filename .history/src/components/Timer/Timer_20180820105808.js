...
export default class Timer extends Component {
	...
	handleModalSubmit = () => {
		console.log('modalSubmit called');
		console.log('input state: ' + this.state.input);
		this.state.input == null ? console.log('empty') : console.log('not empty');
	};
			...
			<View style={{ flex: 1 }}>
				...
				>
					<View style={styles.modalContent}>
						...
						<FormInput inputStyle={styles.modalInput} onChangeText={input => this.setState({ input })} />
						{this.state.error ? (
