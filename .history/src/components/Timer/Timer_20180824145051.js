...
export default class Timer extends Component {
	...
	// 	if (preset) {
	// 		this.setState({ minutes: preset.min, interval: preset.int, ambChecked: preset.music });
	// 		console.log('preset: ' + preset);
	// 		console.log('min: ' + this.state.minutes + 'int: ' + this.state.interval);
	// 	}
	// };

	render() {
		let preset = JSON.stringify(this.props.navigation.state.params);
		console.log('preset: ' + preset.min);
		// this.setState({ minutes: preset.min });
		return (
			<View style={{ flex: 1 }}>
