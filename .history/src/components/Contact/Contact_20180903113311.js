			...
			<View style={styles.container}>
				...
				<ImageBackground source={Images.Backgrounds.contact} style={styles.background}>
					<View style={styles.contentWrap}>
						...
						<Button rounded={true} fontFamily={'Helvetica'} style={styles.button} title="Call Us At 845.782.5575" />
						<Button rounded={true} fontFamily={'Helvetica'} style={styles.button} title="Visit Ananda Ashram" />
						<Button
							rounded={true}
