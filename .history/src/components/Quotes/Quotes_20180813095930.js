	...
	render() {
		...
		return (
			<View style={{ flex: 1, padding: 10, backgroundColor: '#c6d9eb' }}>
				...
				{
					<Text style={styles.quote}>
						Truth is simple and open to all - because it is eternal and always present. But the nature of the mind is to
						complicate it. Truth includes all, accepts all, and purifies all. It is untruth that is difficult and the
