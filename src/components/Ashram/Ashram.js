    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.paragraph}>
          ...
          contributors. The Ashram philosophy is nonsectarian with an emphasis placed on Self-awareness and meditation.
        </Text>
        <Text style={styles.paragraph}>
          Guest and student accommodations provide dorm and semiprivate rooms with around fifty beds. Facilities include
        ...
        <Text style={styles.paragraph}>
          ...
          exploration and application of the principles of Yoga and Vedanta through East-West philosophical and cultural
          exchange. Since its beginning, the Ashram has introduced and hosted many outstanding teachers, guest lecturers
          and artists from various disciplines. A preferred platform is given to those who focus on the underlying unity
        ...
        <Text style={styles.paragraph}>
          ...
          Self as Pure Consciousness, referred to by Shri Brahmananda Sarasvati as the "I-Am" beyond the body and mind.
          These and related teachings are studied at Ananda Ashram both through English sources and through the original
        ...
        <Text style={styles.paragraph}>
          ...
          recognized as a comprehensive and authentic modern synthesis of the classical teachings. The truths expressed
