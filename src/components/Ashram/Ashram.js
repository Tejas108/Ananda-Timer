			...
			<View style={{ flex: 1 }}>
				...
				<ScrollView style={styles.container}>
					...
					<Text style={styles.paragraph}>
						...
						from New York City, founded in 1964 by Shri Brahmananda Sarasvati (then Ramamurti S. Mishra, M.D.) as the
						country center of the Yoga Society of New York, Inc.
					</Text>
					<Text style={styles.paragraph}>
					...
					<Text style={styles.paragraph}>
						...
						include classrooms, meditation room, program halls, temples, memorial shrine, gift shop, seasonal swimming
						pool and publication center. The inspirational Ashram environment is well suited for a meditative retreat,
						holistic studies and exploration of the deeper aspects of life.
					</Text>
					<Text style={styles.paragraph}>Ananda Ashram is easily accessible by car, bus or train.</Text>
					<Text style={styles.heading}>Historical Perspective</Text>
					<Text style={styles.paragraph}>
						...
						cultural exchange. Since its beginning, the Ashram has introduced and hosted many outstanding teachers,
						guest lecturers and artists from various disciplines. A preferred platform is given to those who focus on
						the underlying unity of all. In its core program, Ananda Ashram strives to maintain a distinguished,
						nonsectarian spiritual and educational standard throughout.
					</Text>
					<Text style={styles.heading}>Universal Teachings</Text>
					<Text style={styles.paragraph}>
						Yoga is understood here to be the essential harmony and union of individual existence with cosmic existence,
						as well as the physical, mental and spiritual practices leading to its realization. Non-dualistic Vedanta
						philosophy declares the oneness of all beings in the Supreme Spirit and the ultimate freedom of the Self as
						Pure Consciousness, referred to by Shri Brahmananda Sarasvati as the "I-Am" beyond the body and mind. These
						and related teachings are studied at Ananda Ashram both through English sources and through the original
					...
					<Text style={styles.paragraph}>
						...
						expressed by the great masters, the realized sages and thinkers of various world religions and philosophies
						as well as of the sciences and arts, are incorporated and honored in the light of Vedanta.
					</Text>
				</ScrollView>
			</View>
		);
