...
const Guruji = () => {
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.paragraph}>
        As a pioneer who prepared the ground in the West for a new way of thinking and living, he planted the seeds of Self-knowledge in the hearts of many people the world over. These seeds continue to grow and are destined to help bring about the ultimate goal of world peace and harmony in spiritual unity.
      </Text>
    </ScrollView>
  )
}
