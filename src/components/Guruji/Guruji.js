      ...
      <View style={{ flex: 1 }}>
        <View style={{ alignSelf: 'stretch' }}>
          <Header leftComponent={
            <TouchableOpacity onPress={() => this.props.navigation.dispatch(DrawerActions.openDrawer())}>
              <Icon name="bars" style={{ padding: 10, marginLeft: 10 }} size={20} color="#3C3B85" type={"font-awesome"}/>
            </TouchableOpacity>
          }
        ...
        <ScrollView style={styles.container}>
          ...
          <Text style={styles.paragraph}>
            ...
            science
            and philosophy of Yoga-Vedanta, he combined the universal message of these teachings with his deep knowledge
            of both Eastern and Western medicine and psychology. His areas of specialty ranged from Ayurveda to modern
          ...
          <Text style={styles.paragraph}>
            ...
            (1958)
            and its country center Ananda Ashram (1964). He also established the Yoga Society of San Francisco, Inc.
            (1972), known as Brahmananda Ashram, and inspired several other centers of meditation in the United States
            and
            abroad.
          </Text>
          <Text style={styles.paragraph}>
            ...
            numerous
            essays and stories. In addition, much of his teaching exists in recorded form.
          </Text>
          <Text style={styles.paragraph}>
            ...
            be
            a source of inspiration and guidance for all.
          </Text>
          <Text style={styles.paragraph}>
            As a pioneer who prepared the ground in the West for a new way of thinking and living, he planted the seeds
            of
            Self-knowledge in the hearts of many people the world over. These seeds continue to grow and are destined to
            help bring about the ultimate goal of world peace and harmony in spiritual unity.
          </Text>
        </ScrollView>
      </View>
    )
