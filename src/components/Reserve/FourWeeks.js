...
import { fourweek } from './reserve-landing-content';
import Images from 'assets/images';
import styles from './styles';
import GoBack from './GoBack';

export default class FourWeeks extends Component {
		...
		return (
			<View style={styles.container}>
				...
				<ScrollView>
					...
					>
						<Image source={Images.Reserve.fourweek} style={styles.imageInside} />
						<Text style={styles.headingInside}>{fourweek.title}</Text>
					</View>
					<Button
						rounded={true}
