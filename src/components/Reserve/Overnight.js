...
export default class Overnight extends Component {
    ...
    alignItems: 'center'}}>
					  ...
					  <Text style={styles.headingInside}>Overnight Reservation</Text>
          </View>
          <Button
							rounded={true}
							buttonStyle={styles.button}
              title="Reserve Now"
              onPress={() => Linking.openURL('https://anandaashram.secure.retreat.guru/program/overnight-reservations/?form=1&lang=en')}
						/>
          ...
          <Text style={styles.paragraph}>
           If you are arriving early, be aware
					Check-In is at 4:00 pm and check-out is at 2:00 pm. 
          Registrations accepted until 4 pm the same day. Payment
					for additional meals needs to be made through the office. Additional Yoga Classes are paid at the Yoga Studio.
          </Text>
          <Text style={styles.paragraph}>
          ...
          Included in the Terms and
					Conditions are the Cancellation Policy, Refund Policy, Discounts, Long-Term Guest Policy, Workshop
					Registration, General Policies and Regulations, Data Security, Privacy Notice.
          </Text>
          	<Button
							rounded={true}
							buttonStyle={styles.button}
